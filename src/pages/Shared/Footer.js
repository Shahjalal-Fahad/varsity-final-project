...
const Footer = () => {
  ...
  <div>
    <span className="footer-title">Get Update</span> 
...
<footer className="footer px-10 py-4 ">
  <div className="items-center grid-flow-col">
    ...
    <p className='text-left'>Pleasant Eshop. <br /> Providing reliable product since 2021</p>
  </div> 
...
<footer className="footer footer-center p-4">
  <div>
    <p>Copyright © 2022 - All right reserved by Pleasant Eshop </p>
  </div>
</footer>
        </div>
    );
